...
const ProductDetails = () => {
  ...
  return (
    <div className='container mx-auto p-4'>
            ...
            (
              <div className='flex flex-col gap-1'>
                ...
                <p className='capitalize text-slate-500'>
                  {productCategory.find(item => item.value === data?.category)?.label || "Không xác định"}
                </p>
                ...
                <div className='flex gap-3'>
                    <p className='flex items-center gap-2 text-2xl lg:text-3xl font-medium my-1'>
                        {renderPrice(data?.price, data?.sellingPrice)}
                    </p>
                </div>
      ...
      {
        data.category && (
          <CategroyWiseProductDisplay category={data?.category} heading={"Sản phẩm gợi ý"}/>
        )
      }
